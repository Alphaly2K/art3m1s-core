...
use crate::{
    ...
    EmoteRuntimePipeline, EmoteSceneBounds, EmoteSchemaError, EmoteStaticScene, EmoteStaticSprite,
    EmoteTextureSource, PsbDecryptionKey, PsbError, PsbFile, PsbNormalizeOptions, PsbValue,
};
...
impl EmoteRuntime {
    ...
    pub fn set_runtime_mirror_enabled(&mut self, enabled: bool) -> Result<(), EmoteRuntimeError> {
    ...
    pub fn set_stereovision_enabled(&mut self, enabled: bool) -> Result<(), EmoteRuntimeError> {
    ...
    pub fn evaluated_variable_values_for_stereovision_screen(
        ...
        self.player
            .evaluated_variable_values_for_screen(screen_index)
    }
    ...
    pub fn camera_runtimes(&self) -> &BTreeMap<String, crate::emote::EmoteCameraRuntimeState> {
...
fn initial_variable_values(infos: &[crate::EmoteVariableInfo]) -> BTreeMap<String, f32> {
    infos
        .iter()
